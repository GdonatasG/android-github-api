...
class CustomFragmentFactory @Inject constructor(
    ...
    private val searchViewModelAssistedFactory: SearchViewModel.AssistedSearchViewModelFactory
) :
    FragmentFactory() {
    override fun instantiate(classLoader: ClassLoader, className: String): Fragment {
        return when (className) {
            HomeFragment::class.java.name -> HomeFragment(glide, viewModelFactory)
